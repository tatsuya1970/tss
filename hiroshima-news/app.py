...
date_from = st.sidebar.date_input("開始日", value=_today_jst() - timedelta(days=1))
...
if stats["last_fetch"]:
    ...
    st.sidebar.markdown("Operated by [Tatsuya Takemura](https://tatsuya1970.main.jp/)")
...
with col_main:
    btn_clicked = st.button("🔄 新着情報を取得・AIコメント", type="primary")
